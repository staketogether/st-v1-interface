// Generated by @wagmi/cli@0.1.15 on 5/16/2023 at 9:32:40 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const stakeTogetherABI = [
  ...
  },
  {
    stateMutability: 'payable',
    type: 'function',
    inputs: [{ name: '_delegated', internalType: 'address', type: 'address' }],
    name: 'stake',
    outputs: []
  },
  {
...
export const validatorABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'sharesEncrypted', internalType: 'bytes', type: 'bytes', indexed: false },
      { name: 'amount', internalType: 'uint256', type: 'uint256', indexed: false },
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link validatorABI}__ and `functionName` set to `"validatorIndex"`.
 */
export function useValidatorValidatorIndex<
  TSelectData = ReadContractResult<typeof validatorABI, 'validatorIndex'>
>(
  config: Omit<
    UseContractReadConfig<typeof validatorABI, 'validatorIndex', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    ...
    ...config
  } as UseContractReadConfig<typeof validatorABI, 'validatorIndex', TSelectData>)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link validatorABI}__ and `eventName` set to `"ValidatorRegistered"`.
 */
export function useValidatorValidatorRegisteredEvent(
  config: Omit<
    UseContractEventConfig<typeof validatorABI, 'ValidatorRegistered'>,
    'abi' | 'eventName'
  > = {} as any
) {
  return useContractEvent({
    ...
    ...config
  } as UseContractEventConfig<typeof validatorABI, 'ValidatorRegistered'>)
}
