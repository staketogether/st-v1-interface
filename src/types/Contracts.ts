// Generated by @wagmi/cli@0.1.15 on 5/23/2023 at 6:55:16 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const cethABI = [
  ...
  },
  {
    ...
    type: 'function',
    inputs: [{ name: '_account', internalType: 'address', type: 'address' }],
    name: 'getTempCommunitySharesRewards',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }]
  },
  {
    stateMutability: 'view',
...
export const stakeTogetherABI = [
  ...
  },
  {
    ...
    name: 'ConsensusLayerBalanceUpdated'
  },
  {
    type: 'event',
    anonymous: false,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link cethABI}__ and `functionName` set to `"getTempCommunitySharesRewards"`.
 */
export function useCethGetTempCommunitySharesRewards<
  TSelectData = ReadContractResult<typeof cethABI, 'getTempCommunitySharesRewards'>
>(
  config: Omit<
    UseContractReadConfig<typeof cethABI, 'getTempCommunitySharesRewards', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    abi: cethABI,
    functionName: 'getTempCommunitySharesRewards',
    ...config
  } as UseContractReadConfig<typeof cethABI, 'getTempCommunitySharesRewards', TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link cethABI}__ and `functionName` set to `"getTempUserRewards"`.
 */
export function useCethGetTempUserRewards<
  TSelectData = ReadContractResult<typeof cethABI, 'getTempUserRewards'>
>(
  config: Omit<
    UseContractReadConfig<typeof cethABI, 'getTempUserRewards', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    abi: cethABI,
    functionName: 'getTempUserRewards',
    ...config
  } as UseContractReadConfig<typeof cethABI, 'getTempUserRewards', TSelectData>)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link stakeTogetherABI}__ and `functionName` set to `"getTempCommunitySharesRewards"`.
 */
export function useStakeTogetherGetTempCommunitySharesRewards<
  TSelectData = ReadContractResult<typeof stakeTogetherABI, 'getTempCommunitySharesRewards'>
>(
  config: Omit<
    UseContractReadConfig<typeof stakeTogetherABI, 'getTempCommunitySharesRewards', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    ...
    functionName: 'getTempCommunitySharesRewards',
    ...config
  } as UseContractReadConfig<typeof stakeTogetherABI, 'getTempCommunitySharesRewards', TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link stakeTogetherABI}__ and `functionName` set to `"getTempUserRewards"`.
 */
export function useStakeTogetherGetTempUserRewards<
  TSelectData = ReadContractResult<typeof stakeTogetherABI, 'getTempUserRewards'>
>(
  config: Omit<
    UseContractReadConfig<typeof stakeTogetherABI, 'getTempUserRewards', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    ...
    functionName: 'getTempUserRewards',
    ...config
  } as UseContractReadConfig<typeof stakeTogetherABI, 'getTempUserRewards', TSelectData>)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link stakeTogetherABI}__ and `functionName` set to `"withdrawalsBuffer"`.
 */
export function useStakeTogetherWithdrawalsBuffer<
  TSelectData = ReadContractResult<typeof stakeTogetherABI, 'withdrawalsBuffer'>
>(
  config: Omit<
    UseContractReadConfig<typeof stakeTogetherABI, 'withdrawalsBuffer', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    abi: stakeTogetherABI,
    functionName: 'withdrawalsBuffer',
    ...config
  } as UseContractReadConfig<typeof stakeTogetherABI, 'withdrawalsBuffer', TSelectData>)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link stakeTogetherABI}__ and `eventName` set to `"ConsensusLayerBalanceUpdated"`.
 */
export function useStakeTogetherConsensusLayerBalanceUpdatedEvent(
  config: Omit<
    UseContractEventConfig<typeof stakeTogetherABI, 'ConsensusLayerBalanceUpdated'>,
    'abi' | 'eventName'
  > = {} as any
) {
  return useContractEvent({
    abi: stakeTogetherABI,
    eventName: 'ConsensusLayerBalanceUpdated',
    ...config
  } as UseContractEventConfig<typeof stakeTogetherABI, 'ConsensusLayerBalanceUpdated'>)
}
