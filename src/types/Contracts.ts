// Generated by @wagmi/cli@0.1.15 on 6/5/2023 at 3:05:20 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link sethABI}__ and `functionName` set to `"isPool"`.
 */
export function useSethIsPool<TSelectData = ReadContractResult<typeof sethABI, 'isPool'>>(
  config: Omit<
    UseContractReadConfig<typeof sethABI, 'isPool', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({ abi: sethABI, functionName: 'isPool', ...config } as UseContractReadConfig<
    typeof sethABI,
    'isPool',
    TSelectData
  >)
...
export function useStakeTogetherIsPool<
  TSelectData = ReadContractResult<typeof stakeTogetherABI, 'isPool'>
>(
  config: Omit<
    UseContractReadConfig<typeof stakeTogetherABI, 'isPool', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    ...
    functionName: 'isPool',
    ...config
  } as UseContractReadConfig<typeof stakeTogetherABI, 'isPool', TSelectData>)
}
