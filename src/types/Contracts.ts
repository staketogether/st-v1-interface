// Generated by @wagmi/cli@0.1.15 on 5/22/2023 at 3:30:07 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const cethABI = [
  ...
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [{ name: '_requireOwner', internalType: 'bool', type: 'bool' }],
    name: 'setRestrictOnlyOwner',
    outputs: []
  },
  {
    stateMutability: 'nonpayable',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link cethABI}__ and `functionName` set to `"requireOwner"`.
 */
export function useCethRequireOwner<TSelectData = ReadContractResult<typeof cethABI, 'requireOwner'>>(
  config: Omit<
    UseContractReadConfig<typeof cethABI, 'requireOwner', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    abi: cethABI,
    functionName: 'requireOwner',
    ...config
  } as UseContractReadConfig<typeof cethABI, 'requireOwner', TSelectData>)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link cethABI}__ and `functionName` set to `"setRestrictOnlyOwner"`.
 */
export function useCethSetRestrictOnlyOwner<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof cethABI, 'setRestrictOnlyOwner'>['abi'],
        'setRestrictOnlyOwner'
      > & { functionName?: 'setRestrictOnlyOwner' }
    : UseContractWriteConfig<TMode, typeof cethABI, 'setRestrictOnlyOwner'> & {
        abi?: never
        functionName?: 'setRestrictOnlyOwner'
      } = {} as any
) {
  return useContractWrite<TMode, typeof cethABI, 'setRestrictOnlyOwner'>({
    abi: cethABI,
    functionName: 'setRestrictOnlyOwner',
    ...config
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link cethABI}__ and `functionName` set to `"setRestrictOnlyOwner"`.
 */
export function usePrepareCethSetRestrictOnlyOwner(
  config: Omit<
    UsePrepareContractWriteConfig<typeof cethABI, 'setRestrictOnlyOwner'>,
    'abi' | 'functionName'
  > = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setRestrictOnlyOwner',
    ...config
  } as UsePrepareContractWriteConfig<typeof cethABI, 'setRestrictOnlyOwner'>)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link stakeTogetherABI}__ and `functionName` set to `"requireOwner"`.
 */
export function useStakeTogetherRequireOwner<
  TSelectData = ReadContractResult<typeof stakeTogetherABI, 'requireOwner'>
>(
  config: Omit<
    UseContractReadConfig<typeof stakeTogetherABI, 'requireOwner', TSelectData>,
    'abi' | 'functionName'
  > = {} as any
) {
  return useContractRead({
    ...
    functionName: 'requireOwner',
    ...config
  } as UseContractReadConfig<typeof stakeTogetherABI, 'requireOwner', TSelectData>)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link stakeTogetherABI}__ and `functionName` set to `"setRestrictOnlyOwner"`.
 */
export function useStakeTogetherSetRestrictOnlyOwner<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof stakeTogetherABI, 'setRestrictOnlyOwner'>['abi'],
        'setRestrictOnlyOwner'
      > & { functionName?: 'setRestrictOnlyOwner' }
    : UseContractWriteConfig<TMode, typeof stakeTogetherABI, 'setRestrictOnlyOwner'> & {
        abi?: never
        functionName?: 'setRestrictOnlyOwner'
      } = {} as any
) {
  return useContractWrite<TMode, typeof stakeTogetherABI, 'setRestrictOnlyOwner'>({
    abi: stakeTogetherABI,
    functionName: 'setRestrictOnlyOwner',
    ...config
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link stakeTogetherABI}__ and `functionName` set to `"setRestrictOnlyOwner"`.
 */
export function usePrepareStakeTogetherSetRestrictOnlyOwner(
  config: Omit<
    UsePrepareContractWriteConfig<typeof stakeTogetherABI, 'setRestrictOnlyOwner'>,
    'abi' | 'functionName'
  > = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: 'setRestrictOnlyOwner',
    ...config
  } as UsePrepareContractWriteConfig<typeof stakeTogetherABI, 'setRestrictOnlyOwner'>)
}
