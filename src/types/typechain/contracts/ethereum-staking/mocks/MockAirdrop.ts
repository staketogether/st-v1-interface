...
export interface MockAirdropInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface MockAirdrop extends BaseContract {
  connect(runner?: ContractRunner | null): MockAirdrop;
  waitForDeployment(): Promise<this>;

  interface: MockAirdropInterface;
