...
export interface MockStakeTogetherInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "initializeV2Airdrop",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "mintWithdrawals",
    values: [AddressLike, BigNumberish]
  ): string;
...
export interface MockStakeTogether extends BaseContract {
  connect(runner?: ContractRunner | null): MockStakeTogether;
  waitForDeployment(): Promise<this>;

  interface: MockStakeTogetherInterface;
  ...
  initializeV2Airdrop: TypedContractMethod<
    [_airdrop: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  mintWithdrawals: TypedContractMethod<
  ...
  transferShares: TypedContractMethod<
    [_to: AddressLike, _sharesAmount: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "initializeV2Airdrop"
  ...
  getFunction(
    nameOrSignature: "mintWithdrawals"
  ): TypedContractMethod<
    [account: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
