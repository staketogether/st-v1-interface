...
export interface MockWithdrawalsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface MockWithdrawals extends BaseContract {
  connect(runner?: ContractRunner | null): MockWithdrawals;
  waitForDeployment(): Promise<this>;

  interface: MockWithdrawalsInterface;
