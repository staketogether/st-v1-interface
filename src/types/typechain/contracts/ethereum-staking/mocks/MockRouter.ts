...
export interface MockRouter extends BaseContract {
  ...
  addMerkleRoot: TypedContractMethod<
    [_reportBlock: BigNumberish, merkleRoot: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  initialize: TypedContractMethod<
    [_airdrop: AddressLike, _withdrawals: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[_report: IRouter.ReportStruct], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[_report: IRouter.ReportStruct], [string], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[_config: IRouter.ConfigStruct], [void], "nonpayable">;
  getFunction(
