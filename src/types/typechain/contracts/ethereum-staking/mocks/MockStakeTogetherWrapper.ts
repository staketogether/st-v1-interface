...
export interface MockStakeTogetherWrapperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface MockStakeTogetherWrapper extends BaseContract {
  connect(runner?: ContractRunner | null): MockStakeTogetherWrapper;
  waitForDeployment(): Promise<this>;

  interface: MockStakeTogetherWrapperInterface;
