...
export interface StakeTogetherV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
...
export interface StakeTogetherV2 extends BaseContract {
  connect(runner?: ContractRunner | null): StakeTogetherV2;
  waitForDeployment(): Promise<this>;

  interface: StakeTogetherV2Interface;
  ...
  emitTransfer: TypedContractMethod<
