...
export interface StakeTogetherV4Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
...
export interface StakeTogetherV4 extends BaseContract {
  connect(runner?: ContractRunner | null): StakeTogetherV4;
  waitForDeployment(): Promise<this>;

  interface: StakeTogetherV4Interface;
  ...
  initializeV4: TypedContractMethod<[], [void], "nonpayable">;
