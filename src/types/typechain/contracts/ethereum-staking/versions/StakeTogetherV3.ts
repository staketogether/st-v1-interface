...
export interface StakeTogetherV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
...
export interface StakeTogetherV3 extends BaseContract {
  connect(runner?: ContractRunner | null): StakeTogetherV3;
  waitForDeployment(): Promise<this>;

  interface: StakeTogetherV3Interface;
