...
export interface StakeTogetherInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "ANTI_FRAUD_MANAGER_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "ANTI_FRAUD_SENTINEL_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "l1Adapter", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "lastResetBlock",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    ...
    values: [IStakeTogether.ConfigStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalWithdrawnPool",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "totalWithdrawnValidator",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [IStakeTogether.DelegationStruct[]]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "l1Adapter", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "lastResetBlock",
    data: BytesLike
  ): Result;
...
export namespace SetL1AdapterEvent {
  export type InputTuple = [l1Adapter: AddressLike];
  export type OutputTuple = [l1Adapter: string];
  export interface OutputObject {
    l1Adapter: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export namespace UpdateDelegationsEvent {
  export type InputTuple = [
    account: AddressLike,
    delegations: IStakeTogether.DelegationStruct[]
  ];
  export type OutputTuple = [
    account: string,
...
export interface StakeTogether extends BaseContract {
  ...
  config: TypedContractMethod<
    ...
    [
      [
        ...
        bigint,
        bigint,
        IStakeTogether.FeatureStructOutput
      ] & {
        blocksPerDay: bigint;
        depositLimit: bigint;
        maxDelegations: bigint;
  ...
  l1Adapter: TypedContractMethod<[], [string], "view">;
  ...
  setConfig: TypedContractMethod<
    [_config: IStakeTogether.ConfigStruct],
    [void],
    "nonpayable"
  >;
  ...
  updateDelegations: TypedContractMethod<
    [_delegations: IStakeTogether.DelegationStruct[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "ANTI_FRAUD_MANAGER_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "ANTI_FRAUD_SENTINEL_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[_feeType: BigNumberish], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "l1Adapter"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "lastResetBlock"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "totalWithdrawnPool"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "totalWithdrawnValidator"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getEvent(
    ...
    SetL1AdapterEvent.InputTuple,
    SetL1AdapterEvent.OutputTuple,
    SetL1AdapterEvent.OutputObject
  >;
  getEvent(
    key: "SetRouter"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "SetL1Adapter(address)": TypedContractEvent<
      SetL1AdapterEvent.InputTuple,
      SetL1AdapterEvent.OutputTuple,
      SetL1AdapterEvent.OutputObject
    >;
    SetL1Adapter: TypedContractEvent<
      SetL1AdapterEvent.InputTuple,
      SetL1AdapterEvent.OutputTuple,
      SetL1AdapterEvent.OutputObject
    >;
