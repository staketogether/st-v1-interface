...
export interface IStakeTogetherInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addPool"
      | "addToAntiFraud"
...
export interface IStakeTogether extends BaseContract {
  connect(runner?: ContractRunner | null): IStakeTogether;
  waitForDeployment(): Promise<this>;

  interface: IStakeTogetherInterface;
