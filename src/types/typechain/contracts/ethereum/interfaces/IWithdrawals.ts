...
export interface IWithdrawalsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'initialize'
      | 'isWithdrawReady'
...
export interface IWithdrawals extends BaseContract {
  connect(runner?: ContractRunner | null): IWithdrawals
  waitForDeployment(): Promise<this>

  interface: IWithdrawalsInterface
